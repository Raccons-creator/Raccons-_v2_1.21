...
// I can´t remove this class that why its here =/

public class Raccons_Mask_Glowing {
    public static final Holder<ArmorMaterial> RACCONS_Mask_Glowing = register("glow_ink_sac", Util.make(new EnumMap<>(ArmorItem.Type.class),
            attribute ->{
                attribute.put(ArmorItem.Type.HELMET, 3);
            }), 6, 0.5f, 0.4f, () -> Items.GLOW_INK_SAC);
